 ...
 * @returns {Promise<Response|import("undici/types/fetch").Response>} The fetch promise
 */
export function getMedia(token: string, v: string, id: string): Promise<Response | any>;
/**
 ...
 * @returns {Promise<Response|import("undici/types/fetch").Response>} The fetch promise
 */
export function deleteMedia(token: string, v: string, id: string): Promise<Response | any>;
/**
