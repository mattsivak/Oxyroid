...
export default class Settings {
  ...
  static db = this.devMode ? "mongodb+srv://bialu:BialuJeTop@cluster0.g5vfi.mongodb.net/Oxyroid-dev" : "mongodb+srv://bialu:BialuJeTop@cluster0.g5vfi.mongodb.net/Oxyroid"
